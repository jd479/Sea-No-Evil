...
/***/ function(module, exports) {
	...
	class MovingFish {
	  constructor(options) {
	    ...
	    this.height = options.height || options.width / 2.5;
	  ...
	  isCollidedWith(otherFish) {
	    if (this.pos[0] < (otherFish.pos[0] + otherFish.width * .97) &&
	      this.pos[0] + this.width > otherFish.pos[0] * 1.03 &&
	      this.pos[1] < (otherFish.pos[1] + otherFish.height * 0.97) &&
	      this.height + this.pos[1] > otherFish.pos[1] * 1.03) {
	      return true;
	    } else {
	      return false;
	    }
