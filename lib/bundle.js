...
/***/ function(module, exports) {
	...
	class MovingFish {
	  ...
	  isCollidedWith(otherFish) {
	    if (this.pos[0] + 10 < otherFish.pos[0] + otherFish.width &&
	      this.pos[0] + this.width - 10 > otherFish.pos[0] &&
	      this.pos[1] + 10 < otherFish.pos[1] + otherFish.height &&
	      this.height + this.pos[1] - 15 > otherFish.pos[1]) {
	      return true;
	    } else {
	      return false;
	    }
